...
class Search:
    def search_youtube(self, titleli):
        ...
        for i in range(len(results)):
            embed.add_field(name=str(i+1)+". " + results[i-1]['title'], value='https://www.youtube.com'+results[i-1]['url_suffix'], inline=False)
        return embed
    ...
    def search_image(self, titleli):
        ...
        url = 'https://openapi.naver.com/v1/search/image?sort=sim&display=100&query={}'.format(name)
